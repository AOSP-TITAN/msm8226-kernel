	...
	.file	"bounds.c"
@ GNU C11 (UBERTC-5.3.x) version 5.3.1 20160401 (optimized) (arm-eabi)
@	compiled by GNU C version 5.2.1 20151010, GMP version 6.1.99, MPFR version 3.1.3, MPC version 1.0.3
@ warning: MPFR header version 3.1.3 differs from library version 3.1.2-p3.
@ warning: MPC header version 1.0.3 differs from library version 1.0.1.
@ GGC heuristics: --param ggc-min-expand=100 --param ggc-min-heapsize=131072
@ options passed:  -nostdinc
@ -I /home/mint-fuck/kernel/android_kernel_motorola_msm8226/arch/arm/include
@ -I arch/arm/include/generated -I include -I arch/arm/mach-msm/include
@ -iprefix /home/mint-fuck/toolchain/arm-eabi-5.3/bin/../lib/gcc/arm-eabi/5.3.1/
@ -D__USES_INITFINI__ -D __KERNEL__ -D __LINUX_ARM_ARCH__=7 -U arm
@ -D CC_HAVE_ASM_GOTO -D KBUILD_STR(s)=#s
@ -D KBUILD_BASENAME=KBUILD_STR(bounds)
@ -D KBUILD_MODNAME=KBUILD_STR(bounds)
@ -isystem /home/mint-fuck/toolchain/arm-eabi-5.3/bin/../lib/gcc/arm-eabi/5.3.1/include
@ -include /home/mint-fuck/kernel/android_kernel_motorola_msm8226/include/linux/kconfig.h
@ -MD kernel/.bounds.s.d kernel/bounds.c -mlittle-endian -marm
@ -mabi=aapcs-linux -mno-thumb-interwork -mcpu=cortex-a7 -mfloat-abi=soft
@ -mfpu=vfp -auxbase-strip kernel/bounds.s -O2 -Wall -Wundef
@ -Wstrict-prototypes -Wno-trigraphs -Werror=implicit-function-declaration
@ -Wno-format-security -Wno-sizeof-pointer-memaccess
@ -Wframe-larger-than=1700 -Wno-unused-but-set-variable
@ -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-aliasing
@ -fno-common -fno-delete-null-pointer-checks -fgnu89-inline
